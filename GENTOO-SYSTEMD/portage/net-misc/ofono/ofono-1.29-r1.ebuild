...
PATCHES=(
        "${FILESDIR}/ofono1.patch"
        "${FILESDIR}/ofono.patch"
)
...
#epatch -p1 -i /etc/portage/patches/net-misc/ofono/ofono.patch
#epatch -p1 -i /etc/portage/patches/net-misc/ofono/ofono1.patch
